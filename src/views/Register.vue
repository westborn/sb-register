<template>
  <v-form v-model="isValid" ref="registerForm">
    <v-container>
      ...
      <v-layout row>
        <v-flex xs6 offset-xs1>
          <v-btn @click="submit" class="primary" :disabled="!isValid || sendingToServer"
...
export default {
  data: () => ({
    registerURL: 'https://script.google.com/macros/s/AKfycbxo2AF_dFaA7mALFpgiX_h6INNrcToPCvbDJX0ZB_ClIokJdKMS/exec',
